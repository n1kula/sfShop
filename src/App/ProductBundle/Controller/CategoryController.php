...
use App\ProductBundle\Form\CategoryFilterType;
...
class CategoryController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('AppProductBundle:Category')->createQueryBuilder('e');
    ...
    */
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AppProductBundle:Category:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppProductBundle:Category')->find($id);
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AppProductBundle:Category:edit.html.twig', array(
            'entity'      => $entity,
